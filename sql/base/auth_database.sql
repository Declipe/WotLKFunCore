...
Source Database       : auth2

Target Server Type    : MYSQL
Target Server Version : 50509
File Encoding         : 65001

Date: 2016-12-02 13:40:16
*/
...
-- ----------------------------
-- Table structure for account_banned_copy
-- ----------------------------
DROP TABLE IF EXISTS `account_banned_copy`;
CREATE TABLE `account_banned_copy` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Account id',
  `bandate` int(10) unsigned NOT NULL DEFAULT '0',
  `unbandate` int(10) unsigned NOT NULL DEFAULT '0',
  `bannedby` varchar(50) NOT NULL,
...
-- ----------------------------
-- Records of account_banned_copy
-- ----------------------------
...
-- ----------------------------
INSERT INTO `autobroadcast` VALUES ('-1', '1', '1', 'Visit our Website: http://justacore.cf to vote, donate and watch the news!');
INSERT INTO `autobroadcast` VALUES ('-1', '2', '1', 'Do you enjoy the server?  Please vote to get more players and vote points.');
INSERT INTO `autobroadcast` VALUES ('-1', '3', '1', 'Do you enjoy the server? Please donate so we can keep the server up-and-running.');
INSERT INTO `autobroadcast` VALUES ('-1', '4', '1', 'Visit our Forum:  NoFourmWebpage');
INSERT INTO `autobroadcast` VALUES ('-1', '5', '1', 'Patch-A, B and C is recommended to use to get this core working properly. You can download the patch from the README link.');

-- ----------------------------
-- Table structure for donation_purchases
-- ----------------------------
DROP TABLE IF EXISTS `donation_purchases`;
CREATE TABLE `donation_purchases` (
  `account_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Account Identifier',
  `character_name` varchar(12) CHARACTER SET utf8 NOT NULL DEFAULT '',
  ...
  `donation_item_name` varchar(60) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `donation_item_amount` int(10) unsigned NOT NULL DEFAULT '1',
  `date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Write here a comment if this has been refunded or not.';

-- ----------------------------
-- Records of donation_purchases
-- ----------------------------
...
-- ----------------------------
-- Table structure for ip_banned_copy
-- ----------------------------
...
CREATE TABLE `projects` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `proj_user` varchar(255) COLLATE latin1_german2_ci NOT NULL,
  `proj_name` varchar(255) COLLATE latin1_german2_ci NOT NULL,
  `proj_desc` text COLLATE latin1_german2_ci NOT NULL,
  `proj_path` varchar(255) COLLATE latin1_german2_ci NOT NULL,
  `allow_upload` varchar(3) COLLATE latin1_german2_ci NOT NULL DEFAULT 'no',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci;
...
-- ----------------------------
INSERT INTO `rbac_default_permissions` VALUES ('0', '26');
INSERT INTO `rbac_default_permissions` VALUES ('0', '28');
INSERT INTO `rbac_default_permissions` VALUES ('0', '29');
...
INSERT INTO `rbac_default_permissions` VALUES ('0', '414');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '1');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '2');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '3');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '4');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '5');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '6');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '11');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '13');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '14');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '15');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '16');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '17');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '18');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '19');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '20');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '21');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '22');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '23');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '24');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '25');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '26');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '27');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '28');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '29');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '30');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '31');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '32');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '33');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '34');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '35');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '37');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '38');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '39');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '40');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '41');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '42');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '43');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '44');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '45');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '46');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '47');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '48');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '49');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '50');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '217');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '218');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '219');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '220');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '221');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '222');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '223');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '224');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '225');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '226');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '227');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '228');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '229');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '263');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '300');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '312');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '313');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '314');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '315');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '316');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '317');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '318');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '367');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '368');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '369');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '370');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '371');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '372');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '373');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '374');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '375');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '376');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '377');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '378');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '379');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '380');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '381');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '382');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '383');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '384');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '385');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '386');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '408');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '409');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '410');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '411');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '412');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '413');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '414');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '415');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '416');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '430');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '431');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '432');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '433');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '460');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '461');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '462');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '466');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '467');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '468');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '469');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '470');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '471');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '490');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '496');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '512');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '513');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '514');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '515');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '520');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '524');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '525');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '526');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '527');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '528');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '529');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '530');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '531');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '532');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '533');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '534');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '544');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '545');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '546');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '547');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '548');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '549');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '550');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '551');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '552');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '553');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '554');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '555');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '556');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '557');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '558');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '559');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '560');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '561');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '562');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '563');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '564');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '565');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '566');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '567');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '568');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '569');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '570');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '597');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '598');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '599');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '600');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '720');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '731');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '732');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '737');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '738');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '739');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '740');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '741');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '742');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '743');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '744');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '745');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '746');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '747');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '748');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '749');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '750');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '751');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '752');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '753');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '754');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '755');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '756');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '757');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '758');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '759');
INSERT INTO `rbac_linked_permissions` VALUES ('196', '760');
...
INSERT INTO `rbac_linked_permissions` VALUES ('196', '1009');
...
INSERT INTO `rbac_linked_permissions` VALUES ('198', '1');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '37');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '48');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '239');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '240');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '241');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '242');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '243');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '244');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '245');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '246');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '247');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '248');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '249');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '250');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '251');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '252');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '253');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '254');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '255');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '256');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '273');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '274');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '275');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '276');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '283');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '284');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '287');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '291');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '293');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '295');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '296');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '371');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '372');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '373');
...
INSERT INTO `rbac_linked_permissions` VALUES ('198', '472');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '477');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '478');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '483');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '484');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '488');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '489');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '490');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '494');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '496');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '500');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '504');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '510');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '512');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '515');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '517');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '520');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '521');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '523');
...
INSERT INTO `rbac_linked_permissions` VALUES ('198', '529');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '531');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '532');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '534');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '542');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '543');
...
INSERT INTO `rbac_linked_permissions` VALUES ('198', '602');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '604');
INSERT INTO `rbac_linked_permissions` VALUES ('198', '605');
...
INSERT INTO `rbac_permissions` VALUES ('1009', 'Command: World Chat');
...
-- ----------------------------
INSERT INTO `realmlist` VALUES ('1', 'WotLKFunCore 3.3.5b', '127.0.0.1', '127.0.0.1', '255.255.255.0', '8085', '0', '0', '1', '0', '0', '12340');
...
-- Records of realms
-- ----------------------------
INSERT INTO `realms` VALUES ('2', null, null, null, null, null);

-- ----------------------------
-- Table structure for recovery_log
-- ----------------------------
DROP TABLE IF EXISTS `recovery_log`;
CREATE TABLE `recovery_log` (
  `banTime` int(30) DEFAULT NULL,
  `banIp` varchar(100) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of recovery_log
-- ----------------------------
...
CREATE TABLE `usernames` (
  ...
  `names` varchar(255) COLLATE latin1_german2_ci NOT NULL,
  `organization` varchar(255) COLLATE latin1_german2_ci NOT NULL,
  `email` varchar(255) COLLATE latin1_german2_ci NOT NULL,
  `phone` varchar(255) COLLATE latin1_german2_ci NOT NULL,
  `level` int(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COLLATE=latin1_german2_ci;

-- ----------------------------
-- Records of usernames
-- ----------------------------

-- ----------------------------
-- Table structure for vote_purchases
-- ----------------------------
...
CREATE TABLE `vote_purchases` (
  ...
  `vote_item_name` varchar(60) CHARACTER SET utf8 NOT NULL DEFAULT '',
  `vote_item_amount` int(10) unsigned NOT NULL DEFAULT '1',
  `date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of vote_purchases
-- ----------------------------
