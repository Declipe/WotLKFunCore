...
public:
    ...
    bool OnGossipHello(Player* pPlayer, Creature* pCreature)
    {
	    ...
	    pPlayer->ADD_GOSSIP_ITEM( 10, "- WotLKFunCore Arenas"             , GOSSIP_SENDER_MAIN, 7400);
           if(pPlayer->getLevel() == 255)
           {
           pPlayer->ADD_GOSSIP_ITEM( 10, "- WotLKFunCore Battlemaster's"             , GOSSIP_SENDER_MAIN, 7045);
           }
    ...
    void SendDefaultMenu(Player* pPlayer, Creature* pCreature, uint32 uiAction)
    {
	   ...
	   case 7105: // Ally Boss 200
	    ...
	    case 7500: // Buffs
		    ...
		    pCreature->MonsterSay("Enjoy your buffs!", LANG_UNIVERSAL, NULL);
		    break; 
